                    ...
                    <div class="card-header">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <span id="card_title" style="color:#82adfd; font-size: 50px">
                             ...
                             <div class="float-right">
                                <a href="{{ route('invoice-items.create') }}" class="btn btn-primary btn-sm float-right"  data-placement="left">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('invoice-items.destroy',$invoiceItem->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('invoice-items.show',$invoiceItem->id) }}"><i class="fa fa-fw fa-eye"></i> Show</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('invoice-items.edit',$invoiceItem->id) }}"><i class="fa fa-fw fa-edit"></i> Edit</a>
                                                    @csrf
                                                    @method('DELETE')
