                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('genres.destroy',$genre->id) }}" method="POST">
                                        <a class="btn btn-sm btn-primary " href="{{ route('genres.show',$genre->id) }}"><i class="fa fa-fw fa-eye"></i> Show</a>
                                        @can('is-admin', Auth::user())
                                            <a class="btn btn-sm btn-success" href="{{ route('genres.edit',$genre->id) }}"><i class="fa fa-fw fa-edit"></i> Edit</a>
                                        @endcan
                                        @csrf
                                        @can('is-admin', Auth::user())
                                            @method('DELETE')
